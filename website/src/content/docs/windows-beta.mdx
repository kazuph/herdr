...
The kazuph/herdr fork does not distribute Windows beta binaries through the upstream installer or preview channel. Build and test Windows support from this source tree when needed.
