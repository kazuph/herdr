...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        agent_panel_status_key, agent_panel_toggle_rect, collapsed_sidebar_sections,
        ...
        expanded_sidebar_toggle_rect, jobs_panel_rows, normalized_workspace_scroll,
        sidebar_detail_tab_rects, sidebar_section_divider_rect, sidebar_width_toggle_rects,
        workspace_attention_priority, workspace_drop_indicator_row, workspace_list_entries,
        ...
        workspace_section_new_button_rect, workspace_sections_for_entries, AgentPanelEntry,
        WorkspaceListEntry,
    },
};
pub(crate) use self::{
