...
/// Plugin-driven projection over the built-in Agents view (UP-AUTOMATION-P4,
/// display only). Field/filter/sort shapes mirror the upstream view contract
/// so plugin-authored views keep working; startup hooks stay rejected.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, schemars::JsonSchema)]
