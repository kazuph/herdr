...
returning to its workspace restores it. Mouse drag selection copies text, and
other input including Escape goes to the popup. It closes when the command exits
