...
| 領域 | メソッド |
| --- | --- |
| サーバー | `ping`、`server.stop`、`server.restart`、`server.reload_config`、`server.agent_manifests`、`server.reload_agent_manifests` |
