...
Right-click a workspace to assign it to `⭐ favorites`, `💼 work`, or `🏠 personal`, or to collapse and expand that section. The agents panel only shows agents from expanded workspace sections.
