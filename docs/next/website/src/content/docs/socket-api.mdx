...
Pane commands accept short pane targets like `1-2`, global pane numbers like `23`, tmux-style global pane numbers like `%23`, and full stable IDs like `w6525bc3670d718-2`. `herdr pane list` includes both the short ID and global ID for each pane.
