...
The pane action bar's left `COPY` button cycles through normal copy mode,
a focused pane-only full-screen copy view for phone terminals, and back to the
normal pane view.
...
focus_history_back = "cmd+["
focus_history_forward = "cmd+]"
