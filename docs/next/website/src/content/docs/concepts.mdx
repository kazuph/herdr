...
An agent is a process Herdr recognizes inside a pane. Herdr combines foreground-process evidence with manifest-defined screen rules and optional OSC reports.
